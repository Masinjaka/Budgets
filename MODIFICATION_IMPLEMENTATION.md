...
- [ ] Create the providers in `lib/features/categories/domain/providers/subcategory_expenses_providers.dart`.
- [ ] Create the `SubcategoryExpensesController` in `lib/features/categories/presentation/controllers/subcategory_expenses_controller.dart`.
